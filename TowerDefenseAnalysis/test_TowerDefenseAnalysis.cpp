...
void Test_Examples()
{
	...
	assert(3 == TowerDefenseAnalysis(battlefield, turrets, waves));
	...
	assert(12 == TowerDefenseAnalysis(battlefield, turrets, waves));
	...
	assert(21 == TowerDefenseAnalysis(battlefield, turrets, waves));
	...
	assert(30 == TowerDefenseAnalysis(battlefield, turrets, waves));
}
...
void Test_DifferentSize()
{
	...
	assert(34 == TowerDefenseAnalysis(battlefield, turrets, waves));
	...
	assert(0 == TowerDefenseAnalysis(battlefield, turrets, waves));
	...
	assert(232 == TowerDefenseAnalysis(battlefield, turrets, waves));
	...
	assert(402 == TowerDefenseAnalysis(battlefield, turrets, waves));
